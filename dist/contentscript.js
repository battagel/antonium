...
class PageScanner {
    ...
    scan() {
        ...
        if (content_element) {
            ...
            text_elements = content_element.querySelectorAll("p, h1, h2, h3, h4, h5, h6");
        }
        else {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "DatabaseMgr": () => (/* binding */ DatabaseMgr)
/* harmony export */ });
...
class DatabaseMgr {
  constructor() {
    this.db = new dexie__WEBPACK_IMPORTED_MODULE_0__["default"]("AntoniumDatabase");
  }
...
/*!******************************!*\
  ...
  \******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _page_scanner__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./page_scanner */ "./src/page_scanner.ts");
/* harmony import */ var _database_mgr__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./database_mgr */ "./src/database_mgr.js");
/* harmony import */ var _web_scraper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./web_scraper */ "./src/web_scraper.js");




chrome.storage.sync.get(["option_types"], function (result) {
  const db_mgr = new _database_mgr__WEBPACK_IMPORTED_MODULE_1__.DatabaseMgr();

                            ...
                            <div style={{ display: "flex", marginBottom: "5px" }}>
                                ...
                                >
                                    <div style={{ display: "block" }}>
                                        ...
                                        <Text>Created by Matthew Battagel with help from Annie Talbot and Jeremy Akhavi</Text>
                                        <Text>The page should reload between changing settings. If not, please do this manually.</Text>
                                        <List>
                                            <List.Item>
